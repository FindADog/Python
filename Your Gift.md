 ...
 **如何使用这些base64,byte？**
 ...
 ## 五.小结
文章下面的照片部分已删除，因此不能直接跑通，在本地跑可以直接不用照片的base64 ，byte之类的，另外程序很多地方都写死了，没有抽象出来，大家使用时，记得修改代码。由于是第一次在CSDN写文章，这程序以前完成的，再加上是学生，知识的欠缺，代码肯定有大量冗余的地方，还有关于打包的方法有好办法的请在下面留言，请大家多多包涵。
